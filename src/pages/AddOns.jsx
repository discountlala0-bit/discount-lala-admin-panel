...
function AddOnForm({ defaultValues, cities, onSubmit, loading }) {
        ...
        <Table>
          ...
          <TableBody>
            {isLoading ? (
              ...
              <TableRow><TableCell colSpan={6} className="text-center text-muted-foreground py-10">No add-ons yet.</TableCell></TableRow>
            ) : (
              addOns.map((a) => (
                <TableRow key={a.id}>
